Config = {}
Config.MaleHairOverlays = {
    { -1719270477, -1824026490 },
    { 598190139,   739308497 },
    { 598190139,   495343292 },
    { 598190139,   -1686711653 },
    { 598190139,   1187457341 },
    { 598190139,   956403122 },
    { 598190139,   1647042566 },
    { 598190139,   -461478743 },
    { 598190139,   -1883325653 },
    { 598190139,   -2114248796 },
    { 598190139,   708472048 },
    { 598190139,   1503775674 },
    { 598190139,   1862399610 },
    { 598190139,   -1207367545 },
    { 598190139,   111650251 },
    { 598190139,   -28941494 },
    { 598190139,   -1827173138 },
    { 598190139,   -520681423 },
    { 598190139,   -209343154 },
    { 598190139,   -293579471 },
    { 598190139,   20871853 },
    ...
    { 62137527,    -849980761 },
    { 62137527,    -551553478 },
    { 1529191571,  -1431204514 },
    { 1529191571,  -1133334304 },
    { 1529191571,  -1809784771 },
    { -240234547,  1431846777 },
    { -240234547,  -460168116 },
    { -240234547,  -311245907 },
    { -240234547,  -942031335 },
    { -240234547,  -644503216 },
    { -240234547,  211198653 },
    { 1616273011,  -1119221482 },
    { 1616273011,  -1642199958 },
    { 1347816957,  -599666460 },
    { -1970774728, -416636904 },
    { 601646824,   1334100948 },
}

Config.FemaleHairOverlays = {
    { -1719270477, -1824026490 },
    { 598190139,   104062694 },
    { 598190139,   869579299 },
    { 598190139,   1201332655 },
    { 598190139,   1028967715 },
    { 598190139,   -1651634800 },
    { 598190139,   -892278763 },
    { 598190139,   -1032005779 },
    { 598190139,   -255675400 },
    { 598190139,   1890137027 },
    { 598190139,   -406805808 },
    { 598190139,   -592540500 },
    { 598190139,   205417419 },
    { 598190139,   -2127276619 },
    { 598190139,   -1207367545 },
    { 598190139,   111650251 },
    { 598190139,   3495990 },
    { 598190139,   -285526590 },
    { 598190139,   1907377338 },
    { 598190139,   2136399879 },
    { 598190139,   1568410532 },
    { 598190139,   -1592750929 },
    { 62137527,    -1325458477 },
    { 62137527,    -566725051 },
    { 62137527,    -787850263 },
    { 1529191571,  2039295216 },
    { 1529191571,  1800147054 },
    { 1529191571,  -2019505897 },
    { -240234547,  -328340062 },
    { -240234547,  1657725123 },
    { -240234547,  -1517964336 },
    { -240234547,  1677522529 },
    { -240234547,  1841934566 },
    { -240234547,  1521494915 },
    { 1616273011,  687338866 },
    { 1616273011,  1827923343 },
    { 1347816957,  987747946 },
    { -1970774728, -49274924 },
    { 601646824,   -974054285 },
}
...
local function setPlayerAppearance(payload, entity, cb)
    if not next(payload) then
        return
    end

    ClearPedDecorations(entity)
    ...
    if payload.appearance then
        SetPedHeadBlendData(
            ...
            payload.appearance.head_blend[2],
            payload.appearance.head_blend[3],
            payload.appearance.head_blend[4],
            payload.appearance.head_blend[5],
            payload.appearance.head_blend[6],
            payload.appearance.head_blend[7] + 0.0,
            payload.appearance.head_blend[8] + 0.0,
        ...
        SetPedFaceFeature(entity, 4, payload.appearance.nose_length_tip[2] + 0.0)
        SetPedFaceFeature(entity, 5, payload.appearance.nose_twist_curveness[1] + 0.0)
        SetPedFaceFeature(entity, 3, payload.appearance.nose_twist_curveness[2] + 0.0)
        SetPedFaceFeature(entity, 7, payload.appearance.eyebrow[1] + 0.0)
        SetPedFaceFeature(entity, 6, payload.appearance.eyebrow[2] + 0.0)
        SetPedFaceFeature(entity, 10, payload.appearance.cheek_width_height[1] + 0.0)
        SetPedFaceFeature(entity, 8, payload.appearance.cheek_width_height[2] + 0.0)
        SetPedFaceFeature(entity, 9, payload.appearance.cheek_size + 0.0)
        SetPedFaceFeature(entity, 11, payload.appearance.eye_opening + 0.0)
        SetPedFaceFeature(entity, 12, payload.appearance.lip_thickness + 0.0)
        SetPedFaceFeature(entity, 13, payload.appearance.jaw_width_shape[1] + 0.0)
        SetPedFaceFeature(entity, 14, payload.appearance.jaw_width_shape[2] + 0.0)
        SetPedFaceFeature(entity, 16, payload.appearance.chin_length_height[1] + 0.0)
        SetPedFaceFeature(entity, 15, payload.appearance.chin_length_height[2] + 0.0)
        SetPedFaceFeature(entity, 17, payload.appearance.chin_shape_hole[1] + 0.0)
        SetPedFaceFeature(entity, 18, payload.appearance.chin_shape_hole[2] + 0.0)
        SetPedFaceFeature(entity, 19, payload.appearance.neck_thickness + 0.0)

        SetPedEyeColor(entity, payload.appearance.eye_color)

        SetPedHeadOverlay(entity, 0, payload.appearance.blemishes[1], payload.appearance.blemishes[2] + 0.0)
        SetPedHeadOverlay(entity, 1, payload.appearance.facial_hair[1], payload.appearance.facial_hair[2] + 0.0)
        SetPedHeadOverlayColor(entity, 1, 1, payload.appearance.facial_hair[3], payload.appearance.facial_hair[3])
        SetPedHeadOverlay(entity, 2, payload.appearance.eyebrows[1], payload.appearance.eyebrows[2] + 0.0)
        SetPedHeadOverlayColor(entity, 2, 1, payload.appearance.eyebrows[3], payload.appearance.eyebrows[3])
        SetPedHeadOverlay(entity, 3, payload.appearance.ageing[1], payload.appearance.ageing[2] + 0.0)
        SetPedHeadOverlay(entity, 4, payload.appearance.makeup[1], payload.appearance.makeup[2] + 0.0)
        SetPedHeadOverlayColor(entity, 4, 2, payload.appearance.makeup[3], payload.appearance.makeup[4])
        SetPedHeadOverlay(entity, 5, payload.appearance.blush[1], payload.appearance.blush[2] + 0.0)
        SetPedHeadOverlayColor(entity, 5, 2, payload.appearance.blush[3], payload.appearance.blush[3])
        SetPedHeadOverlay(entity, 6, payload.appearance.complexion[1], payload.appearance.complexion[2] + 0.0)
        SetPedHeadOverlay(entity, 7, payload.appearance.sun_damage[1], payload.appearance.sun_damage[2] + 0.0)
        SetPedHeadOverlay(entity, 8, payload.appearance.lipstick[1], payload.appearance.lipstick[2] + 0.0)
        SetPedHeadOverlayColor(entity, 8, 2, payload.appearance.lipstick[3], payload.appearance.lipstick[3])
        SetPedHeadOverlay(entity, 9, payload.appearance.moles_freckles[1], payload.appearance.moles_freckles[2] + 0.0)
        SetPedHeadOverlay(entity, 10, payload.appearance.chest_hair[1], payload.appearance.chest_hair[2] + 0.0)
        SetPedHeadOverlayColor(entity, 10, 1, payload.appearance.chest_hair[3], payload.appearance.chest_hair[3])
        SetPedHeadOverlay(entity, 11, payload.appearance.body_blemishes[1], payload.appearance.body_blemishes[2] + 0.0)
        SetPedHeadOverlay(entity, 12, payload.appearance.add_body_blemishes[1],
            payload.appearance.add_body_blemishes[2] + 0.0)

        SetPedComponentVariation(entity, 2, payload.appearance.hair[1], payload.appearance.hair[2], 2)
        SetPedHairColor(entity, payload.appearance.hair[3], payload.appearance.hair[4])
        SetHairOverlay(payload.appearance.hair[5], entity)
    end


    SetPedComponentVariation(entity, 1, payload.clothes.mask[1], payload.clothes.mask[2], 0)
    SetPedComponentVariation(entity, 3, payload.clothes.arms[1], payload.clothes.arms[2], 0)
    SetPedComponentVariation(entity, 4, payload.clothes.pants[1], payload.clothes.pants[2], 0)
    SetPedComponentVariation(entity, 5, payload.clothes.bag[1], payload.clothes.bag[2], 0)
    SetPedComponentVariation(entity, 6, payload.clothes.shoes[1], payload.clothes.shoes[2], 0)
    SetPedComponentVariation(entity, 7, payload.clothes.accessory[1], payload.clothes.accessory[2], 0)
    SetPedComponentVariation(entity, 8, payload.clothes['t-shirt'][1], payload.clothes['t-shirt'][2], 0)
    SetPedComponentVariation(entity, 9, payload.clothes.vest[1], payload.clothes.vest[2], 0)
    SetPedComponentVariation(entity, 10, payload.clothes.decals[1], payload.clothes.decals[2], 0)
    SetPedComponentVariation(entity, 11, payload.clothes.torso2[1], payload.clothes.torso2[2], 0)

    if payload.clothes.hat[1] == -1 then
        ClearPedProp(entity, 0)
    else
        SetPedPropIndex(entity, 0, payload.clothes.hat[1], payload.clothes.hat[2], true)
    end

    if payload.clothes.glass[1] == -1 then
        ClearPedProp(entity, 1)
    else
        SetPedPropIndex(entity, 1, payload.clothes.glass[1], payload.clothes.glass[2], true)
    end

    if payload.clothes.ear[1] == -1 then
        ClearPedProp(entity, 2)
    else
        SetPedPropIndex(entity, 2, payload.clothes.ear[1], payload.clothes.ear[2], true)
    end

    if payload.clothes.watch[1] == -1 then
        ClearPedProp(entity, 6)
    else
        SetPedPropIndex(entity, 6, payload.clothes.watch[1], payload.clothes.watch[2], true)
    end

    if payload.clothes.bracelet[1] == -1 then
        ClearPedProp(entity, 7)
    else
        SetPedPropIndex(entity, 7, payload.clothes.bracelet[1], payload.clothes.bracelet[2], true)
    end

    if payload.tattoos then
        SetTattoos(payload.tattoos, entity)
    end


    local skin = exports['nf-skin']:GetPedAppearance(entity)
    cb(skin)
end

function SetTattoos(payload, playerPed)
    if not next(payload) then
        return
    end

    for _, values in pairs(payload) do
        for _, tattooValue in pairs(values) do
            local hash = tattooValue.hashMale
            if not exports['nf-skin']:IsPedMaleModel(playerPed) then
                hash = tattooValue.hashFemale
            end

            AddPedDecorationFromHashes(playerPed, tattooValue.collection, hash)
        end
    end
end

function SetHairOverlay(value, playerPed)
    if value > 0 then
        local hairOverlays = Config.MaleHairOverlays[value]
        if not exports['nf-skin']:IsPedMaleModel(playerPed) then
            hairOverlays = Config.FemaleHairOverlays[value]
        end

        if not hairOverlays then
            return
        end

        AddPedDecorationFromHashes(playerPed, hairOverlays[1], hairOverlays[2])
    end
end

RegisterNetEvent('nf-skin_migrate:client:nf-skin', function(playerSkin, type)
    lib.requestModel(playerSkin.model)
    SetPlayerModel(PlayerId(), playerSkin.model)
    SetModelAsNoLongerNeeded(playerSkin.model)
    ...
    setPlayerAppearance(playerSkin.skin, cache.ped, function(skin)
        TriggerServerEvent("nf-skin_migrate:server:nf-skin_done",
